...
Folowing changes have been made in comparison to Python 2.7.11rc1:
-the bugfix from http://bugs.python.org/file14469/zipfile.py is included
-renaming to zipfile_
"""
"""
...
def main(args = None):
    ...
    USAGE=textwrap.dedent("""\
        Usage:
            zipfile_.py -l zipfile.zip        # Show listing of a zipfile
            zipfile_.py -t zipfile.zip        # Test if a zipfile is valid
            zipfile_.py -e zipfile.zip target # Extract zipfile into target dir
            zipfile_.py -c zipfile.zip src ... # Create zipfile from sources
        """)
    if args is None:
        args = sys.argv[1:]
